...
QVariantList MatchReview::find_blunders()
{
    ...
    // each of their turns to determine the best available moves and compares those
    // with the moves the user chose to play to decide if the move they made was good or not
